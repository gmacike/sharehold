...
urlpatterns = [
    ...
    url(r'^warehouse-autocomp/$', views.WarehouseAutocompleteView.as_view(), name='warehouse-autocomplete'),
    url(r'^warehouse/select/(?P<wrhpk>\d+)$', views.warehouse_select, name='warehouse_select'),
